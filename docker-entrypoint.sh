...
su - idol -c 'cd /opt/HewlettPackardEnterprise/Find && java -Dhp.find.home=/opt/HewlettPackardEnterprise/Find/home -Dserver.port=8080 -jar /opt/HewlettPackardEnterprise/Find/find.war -uriEncoding utf-8'
while true; do
  sleep 1
done
